...
class BaseCollector(ABC):
    ...
    Every collector (Reddit, arXiv, Twitter, etc.) inherits from this
    and must implement the `collect()` method.

    Provides:
    - `matches_topics()` — checks if a piece of text matches any configured topic tags
    """
    ...
    def collect(self) -> List[ContentItem]:
        """Scrape source and return a list of ContentItem objects."""
        pass

    def matches_topics(self, text: str) -> List[str]:
        """
        Check if text matches any configured topic tags.
        Returns the list of matched tags (empty if none matched).
        """
